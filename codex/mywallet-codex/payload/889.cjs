...
// EXTERNAL MODULE: ./headless/runtime/assetCapabilities.ts
var assetCapabilities = __webpack_require__(24220);
...
const TON_WALLET_VERSION_VALUES = ['simpleR1', 'simpleR2', 'simpleR3', 'v2R1', 'v2R2', 'v3R1', 'v3R2', 'v4R2', 'W5'];
...
const TON_WALLET_VERSION_PROPERTY = {
  type: 'string',
  enum: [...TON_WALLET_VERSION_VALUES]
};
...
const CREATE_WALLET_INPUT_SCHEMA = createObjectInputSchema({
  ...
  walletVersion: TON_WALLET_VERSION_PROPERTY
}, ['password']);
