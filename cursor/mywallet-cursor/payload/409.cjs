...
async function executeHeadlessCli(options) {
  ...
  try {
    const {
      ...
      env: {
        ...{"APP_ENV":"test"},
        APP_ENV: {"APP_ENV":"test"}.APP_ENV ?? 'test'
      },
